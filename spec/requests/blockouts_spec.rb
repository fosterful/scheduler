...
RSpec.describe 'Blockouts', type: :request do
  ...
  describe '#create' do
    context 'with unauthorized params' do
      it 'is unauthorized' do
        allow_any_instance_of(BlockoutsController)
          .to receive(:authorize).and_raise(Pundit::NotAuthorizedError)
    ...
    context 'with valid params' do
      it 'is successful and returns the blockout' do
        post blockouts_path,
             as:     :json,
             params: { blockout: attributes_for(:blockout) }
  ...
  describe '#update' do
    context 'with valid params' do
      ...
      it 'is successful and returns the blockout' do
        put blockout_path(blockout),
            as:     :json,
            params: { blockout: { exdate: [time] } }
    ...
    context 'with invalid params' do
      it 'is unprocessable' do
        put blockout_path(blockout),
            as:     :json,
            params: { blockout: { start_at: 1.day.ago } }
